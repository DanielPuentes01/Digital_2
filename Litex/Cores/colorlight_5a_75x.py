...
from mult_ASM import mult_32
from divider_ASM import div_16
from raiz_ASM import raiz_16
        ...
        **kwargs):
        ...
        if not self.integrated_main_ram_size:
            ...
            if board == "5a-75b" and revision == "6.1":
                sdram_cls  = EM636165
            elif (board == "5a-75e" and revision == "6.0") or (board == "5a-75b" and (revision == "8.0" or revision == "8.2")) or (board == "5a-75e" and revision == "8.2"):
        ...
        self.csr.add("div0")
        self.submodules.div0 = div_16.Div16(platform)

        self.csr.add("raiz0")
        self.submodules.raiz0 = raiz_16.Raiz16(platform)
